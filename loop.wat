(module
  ...
  (import "env" "emscripten_memcpy_big" (func (;1;) (type 3)))
  (func (;2;) (type 6)
    i32.const 68480
    global.set 3
    i32.const 2944
    ...
    i32.const 42
    i32.store)
  (func (;3;) (type 7) (param i32 i32) (result i32)
    ...
    loop  ;; label = @1
      ...
      local.get 1
      v128.load
      v128.const i32x4 0x00000064 0x00000064 0x00000064 0x00000064
      i32x4.add
      v128.store
      local.get 1
      local.get 1
    ...
    local.get 0
    local.get 0
    i32.load offset=40004
    i32.const 100
    i32.add
    i32.store offset=40004
    local.get 0
    local.get 0
    i32.load offset=40008
    i32.const 100
    i32.add
    local.tee 1
    i32.store offset=40008
    local.get 0
    local.get 1
    i32.store
    global.get 0
  ...
  (export "dynCall_jiji" (func 24))
  (elem (;0;) (i32.const 1) func 5 4 6)
  (data (;0;) (i32.const 1024) "-+   0X0x\00(null)\00array[9998]: %d\0a")
  ...
  (data (;16;) (i32.const 1588) "\02\00\00\00\03\00\00\00\b8\06\00\00\00\04")

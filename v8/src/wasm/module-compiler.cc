...
ExecutionTierPair GetDefaultTiersPerModule(NativeModule* native_module,
  ...
  bool wasm_tier_up = v8_flags.wasm_tier_up;
  ExecutionTier top_tier =
      eager_tier_up ? ExecutionTier::kTurbofan : baseline_tier;
  PrintF("dynamic_tiering: %hhd, wasm_tier_up: %d, eager_tier_up: %hhd, baseline_tier: %hhd, top_tier: %hhd\n", dynamic_tiering, wasm_tier_up, eager_tier_up, baseline_tier, top_tier);
